...
<?php
	...
	function createRatingString($rating,$userIsModHere){
		...
		$modString= ($rating['ismod'])?'<img alt="Moderator" src="'.APP_PATH.'/templates/img/moderator.png">':"" ;
		$suString= ($rating['issuperuser'])?'<img alt="Sueruser" src="'.APP_PATH.'/templates/img/superuser.png">':"" ;
