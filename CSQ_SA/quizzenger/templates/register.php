<div class="container">
	<div class="row">
		...
		<h2>Registration</h2>
		<p>Die Registration ist kostenlos, sicher, mühelos und ermöglicht Ihnen Zugriff auf viele zusätzliche Funktionen.</p>
		<hr>
		<form class="register_form" action="./index.php?view=processRegistration"  method="post" id="register_form" name="register_form">
			...
			<p style="text-align:center">
				Durch das Abschliessen der Registration auf Quizzenger stimmen Sie zu,
				dass Sie die <a href="<?php echo APP_PATH . '?view=about' ?>">Benutzungsrichtlinien der HSR</a> akzeptieren.
			</p>
