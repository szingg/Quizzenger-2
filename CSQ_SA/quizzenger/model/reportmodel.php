...
class ReportModel {
	...
	public function checkIfUserAlreadyDoneReport($type, $object_id, $by_user_id) {
		if($type=="question"){
	...
	public function addReport($type, $object_id, $message, $by_user_id, $category_id = "NULL") {
	...
	public function getQuestionReportsByCategory($category) {
	...
	public function getRatingReportsByCategory($category) {
	...
	public function getQuestionReportsByUser($user_id) {
	...
	public function getRatingReportsByUser($user_id) {
	...
	public function getReportsByObject($object_id, $type) {
		if($type == "question"){
	...
	public function removeReportsByObject($object_id, $type, $user_id) {
		if($type == "question"){
